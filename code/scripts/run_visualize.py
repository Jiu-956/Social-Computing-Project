...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate modal and temporal visualization reports from a checkpoint.")
    ...
    evaluate_checkpoint(config, dataset, args.checkpoint)
    print("Visualization reports generated.")
